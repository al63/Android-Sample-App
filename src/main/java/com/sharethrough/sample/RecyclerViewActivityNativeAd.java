...
public class RecyclerViewActivityNativeAd extends Activity {
    // prelive monetize placement
    public static final String PLACEMENT_KEY = "9e987ada";
    ...
    protected void onResume() {
        ...
        customKeyValues.put("sharethrough_creative_key", "8367dff2");
