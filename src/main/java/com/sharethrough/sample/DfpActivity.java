...
import com.sharethrough.messytruth.*;
...
public class DfpActivity extends Activity {
    ...
    private void setupListAdapter() {
        ...
        if (savedSharethrough != null) {
            ...
            sharethrough = new Sharethrough(this, PLACEMENT_KEY, true, savedSharethrough);
            savedSharethrough = null;
        } else{
            sharethrough = new Sharethrough(this, PLACEMENT_KEY, true);
        }
