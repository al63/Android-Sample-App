...
public class SharethroughListAdapterActivity extends Activity {
    ...
    private static final FeedItem[] FEED = {
            ...
            new FeedItem(R.drawable.education, "Screen Time Study Finds Educathaion Drop-Off", "According to a study, less than half the time that children age 2 to 10 spend watching or interacting with…"),
